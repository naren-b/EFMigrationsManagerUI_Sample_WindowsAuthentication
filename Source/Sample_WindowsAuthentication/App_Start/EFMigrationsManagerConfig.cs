[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Sample_WindowsAuthentication.EFMigrationsManagerConfig), "Register")]
namespace Sample_WindowsAuthentication
{
	using Sample_WindowsAuthentication.Controllers;
